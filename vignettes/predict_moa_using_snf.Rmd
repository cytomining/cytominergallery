...
network fusion algorithm (SNFD). See the vignette `single_cell_analysis` for
...
profiles %>% 
  summarise('number of selected features' = n()) %>% 
  print()
...
Get we better results using SNF?
```{r}
