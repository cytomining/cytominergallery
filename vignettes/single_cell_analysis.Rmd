...
## Plot integrated DAPI intensity (per cell) for a treatment
...
Finally, let's plot the relationship between a pair of variables from this 
summarized data
