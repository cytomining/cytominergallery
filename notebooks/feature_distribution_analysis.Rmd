...
remove_outliers <- function(x) {
  upper.end.outlier <- outliers::scores(x, type = "iqr", lim = 1.5)  
  lower.end.outlier <- outliers::scores(-x, type = "iqr", lim = 1.5)  
  x[which(!(upper.end.outlier | lower.end.outlier))]
}
...
features_statistics %>% 
  ...
  knitr::kable(caption = "Feature outlier threshold table", digits = 3)
